...
$uri = "https://samsteamsextension.blob.core.windows.net/msteamsextension/$($CustID)?sv=2021-06-08&ss=b&srt=sco&sp=wactf&se=2023-11-16T12:00:00Z&st=2023-02-16T12:00:00Z&spr=https&sig=$key"
